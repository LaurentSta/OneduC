function afficherBoutonSuivantDepuisIframe() {
    ...
    if (bouton) {
        ...
        bouton.classList.add('opacity-100', 'scale-105');
        bouton.style.pointerEvents = 'auto';

        // Effet rebond (agrandissement temporaire)
        setTimeout(() => {
            bouton.classList.remove('scale-105');
        }, 500); // revient à la taille normale après 0.5s

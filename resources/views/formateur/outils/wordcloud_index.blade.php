  ...
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
    ...
    <div class="lg:col-span-1">
      <div class="bg-white rounded-[20px] shadow-md p-6 sticky top-6">
        <p class="font-varela text-base font-bold text-bleuone mb-1">Nouveau nuage de mots</p>
        <p class="mb-4 text-xs leading-5 text-gray-500">Le premier écran stagiaire s’ouvre sur la question 1. Vous pilotez la suite depuis le live.</p>

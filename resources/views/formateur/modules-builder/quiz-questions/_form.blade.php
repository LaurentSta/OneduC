{{-- resources/views/formateur/modules-builder/quiz-questions/_form.blade.php --}}
{{-- Formulaire de création d'une question (réutilisé par create.blade.php et l'onglet "Ajouter une question" de la vue unifiée). --}}
<div x-data="quizManager()">
  ...
  <form method="POST"
        action="{{ route('formateur.modules.builder.lectures.quiz.questions.store', ['lecture' => $lecture->id]) }}"

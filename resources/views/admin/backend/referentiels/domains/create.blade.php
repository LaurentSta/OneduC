...
<div class="max-w-[1248px] mx-auto px-4">
    <div class="bg-white rounded-[20px] shadow-md p-8 my-10 w-full">
        <x-typography variant="titre">Ajouter un domaine</x-typography>
        <x-typography variant="sous-titre" class="font-varela text-orangeone">
            Référentiel : {{ $referentiel->name }}
        </x-typography>

        <div class="prose-oneduc mt-4">
            Un domaine est une catégorie de compétences (optionnelle).  
            Exemple : “Information et données”, “Communication”, “Sécurité”, etc.
        </div>
    </div>
</div>
...
<div class="max-w-[1248px] mx-auto px-4">
    <div class="bg-white rounded-[20px] shadow-md p-8 my-10 w-full">
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b">
            <h2 class="text-xl font-semibold text-gray-800">Nouveau domaine</h2>
        ...
        <form action="{{ route('admin.referentiels.domains.store', $referentiel) }}" method="POST" class="px-6 py-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <input
                    ...
                    placeholder="Ex : Sécurité numérique"
                >
                @error('name')

{{-- /home/laurents/Oneduc_Dev/resources/views/admin/backend/souscategorie/edit_sous-categorie.blade.php --}}
...
<div class="w-full px-6 lg:px-8">
    <div class="bg-white rounded-[20px] shadow-soft p-6 my-6 w-full border border-gray-100">
        ...
        <div class="flex flex-col gap-2 border-b border-gray-100 pb-4 mb-6">
            <h1 class="text-[20px] font-varela text-bleuone">Modifier la sous-catégorie</h1>
            <p class="text-sm text-gray-600">
                Mettre à jour la catégorie parente, les informations et l’image associée.
            </p>
        </div>

        <form method="POST"
              action="{{ route('admin.subcategories.update') }}"
            ...
            <div>
                ...
                <textarea id="subcategory_description"
                          ...
                          rows="4"
                          placeholder="Décris la sous-catégorie en quelques lignes…"
                          class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm
                                 focus:ring-orangeone focus:border-orangeone text-sm">{{ old('subcategory_description', $subcategory->subcategory_description) }}</textarea>
                ...
                <div class="sm:col-span-3">
                    ...
                    <img id="preview-image"
                         src="{{ $subcategory->subcategory_image
                                ...
                                : asset('upload/category_images/NoImage.png') }}"

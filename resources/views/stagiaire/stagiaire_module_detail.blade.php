    ...
    <div class="col-span-12 md:col-span-9">
      ...
      <nav class="text-sm font-varela text-gray-600 mt-2" aria-label="Fil d'Ariane">
        <ol class="inline-flex items-center space-x-1">
          <li><a href="{{ route('stagiaire.dashboard') }}" class="text-orangeone hover:underline">Accueil</a></li>
          <li class="text-gray-400">/</li>
          <li><a href="#" class="text-orangeone hover:underline">Mes modules</a></li>
          <li class="text-gray-400">/</li>
  ...
  <section class="flex flex-col lg:flex-row gap-6">
    ...
    <div class="w-full lg:w-2/3 bg-white rounded-[20px] shadow-md p-6" x-data="{ active: 'presentation' }">
      ...
      <div class="mt-2 space-y-4">
        {{-- Présentation --}}
        <div x-show="active==='presentation'" x-cloak>
        ...
        {{-- Prérequis --}}
        <div x-show="active==='prerequis'" x-cloak>
          ...
          @foreach ($module->sections as $index => $section)
            <div class="border border-gray-200 rounded">
              ...
              <button
                ...
                <svg :class="{'rotate-180': open === {{ $index }}}" class="w-5 h-5 transform transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              @if (isset($sectionProgress[$section->id]) && $sectionProgress[$section->id]['total'] > 0)
                ...
                <div class="w-full bg-gray-200 h-2" role="progressbar" aria-valuenow="{{ $percent }}" aria-valuemin="0" aria-valuemax="100">
    ...
    <aside class="w-full lg:w-1/3 space-y-6">
      <div class="bg-white p-6 rounded-[20px] shadow-md">
        ...
        <div class="mb-6">
          ...
          <div class="w-full bg-gray-200 rounded h-3 mt-1" role="progressbar" aria-valuenow="{{ $progression }}" aria-valuemin="0" aria-valuemax="100">

...
<div class="max-w-[1285px] mx-auto px-8">
  <header class="bg-white rounded-[20px] shadow-md px-8 pt-4 pb-6 w-full mb-6">
    ...
    <p class="font-varela text-sous-titre text-orangeone">Module terminé : {{ $module->module_name }}</p>
  </header>
  ...
  <section class="bg-white rounded-[20px] shadow-md p-6">
    ...
    <div class="mt-6">
      <a href="{{ route('stagiaire.modules') }}" class="inline-block px-4 py-2 rounded-lg bg-bleuone text-white">
        Retour aux modules
      </a>
    </div>
  </section>
